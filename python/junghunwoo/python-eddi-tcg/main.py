...
class Card:
    ...
    def load_image(self):
            try:
                ...
                self.illustrator_image = ImageTk.PhotoImage(image)
...
class CardGameApp:
    def __init__(self, master):
        ...
        # self.card1 = Card("Card 1", "images/machine/unit/1/card1.png", "가즈아", "Characteristic 1", "Skill 1", "Skill 2")
        # self.card2 = Card("Card 2", "images/machine/unit/2/card2.png", "고고싱", "Characteristic 2", "Skill 3", "Skill 4")
        self.card1 = cards[0]
        self.card2 = cards[1]
...
if __name__ == "__main__":
    root = tkinter.Tk()
    excel_file_path = "card_data.xlsx"
    cards = load_cards_from_excel(excel_file_path)
